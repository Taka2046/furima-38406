...
ActiveRecord::Schema.define(version: 2023_01_13_165857) do
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "firstname_in_kanji", default: "", null: false
    t.string "lastname_in_kanji", default: "", null: false
    t.string "firstname_in_kana", default: "", null: false
    t.string "lastname_in_kana", default: "", null: false
